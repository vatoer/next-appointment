...
export async function GET(
  ...
  const formDataJson = await spriSchema.spa(filledForm?.formDataJson);

  if (formDataJson.success !== true) {
    return new NextResponse("error", { status: 400 });
  }

  const formData = formDataJson.data;
  ...
  try {
    ...
    const formDataSpriPage1: IFormData = {
      ...
      tanggalPermohonan: {
        ...
        maxCharPerRow: 8,
        row: 1,
        value: format(filledForm.createdAt, "ddMMyy"),
      },
      namaLengkap: {
        x: 110,
        y: height - 275,
      ...
      suamiIstriTanggalLahir: {
        ...
        maxCharPerRow: 6,
        row: 1,
        value: formData.suamiIstriTanggalLahir
          ? format(formData.suamiIstriTanggalLahir, "ddMMyy")
          : "",
      },
