...
const BookedServiceLayout = ({
  ...
  return (
    <div className="relative min-h-screen items-center flex flex-col">
      ...
      <div className="w-full lg:w-2/3 p-2 backdrop-blur h-[64px] fixed inset-y-0 z-50 ">
        {/* Make navbar fixed to the top */}
        <Navbar />
      </div>
      <div className="pt-[64px] flex flex-col items-center w-full min-h-screen \">
...
export default BookedServiceLayout;
